...
- создать массив typical-keys, tk, в нем объекты {dialect, ultima, oxia, nom, gen, keys? или key?}
...
- перечислить стемы и, если мало, иметь в списке исключений?
...
- стянуть свежий dvor в отдельные файлы
- вторая утилита - определение type, subtype, aug, etc
